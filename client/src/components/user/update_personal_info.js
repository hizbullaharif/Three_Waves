...
class UpdatePersonalNfo extends Component {
  ...
  componentDidMount() {
    // console.log(
    //   "Component Did mount of update personal info",
    //   this.state.formdata
    // );
    ...
    // const newFormData = populateOptionFields(this.state.formdata,this.props.user.userData);        // const newFormData = populateOptionFields(this.state.formdata,this.props.user.userData);
    this.setState({
      formdata: newFormData,
    });
  }
